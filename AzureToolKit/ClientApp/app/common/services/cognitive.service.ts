...
export class CognitiveService {
  bingSearchAPIKey = 'bb48ec8905f2476a9f8712ce68bfe1b8';
  computerVisionAPIKey = '393789a10d224774ac32510beb097ff5';
  ...
  analyzeImage(request: ComputerVisionRequest): Observable<ComputerVisionResponse> {
    return this.http.post('https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze?visualFeatures=Description,Tags,Faces', this.computerVisionAPIKey, request)
